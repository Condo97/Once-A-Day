...
CGSize const DefaultFrameSize                             = (CGSize){1008, 1334};
                                      ...
                                      size:(CGSize)imageSize
{
    ...
    //NSPparameterAssert(context);
    
    //CGContextDrawImage(context, CGRectMake(0 + (imageSize.width-CGImageGetWidth(image))/2,(imageSize.height-CGImageGetHeight(image))/2, CGImageGetWidth(image), CGImageGetHeight(image)), image);
    //CGContextRotateCTM(context, M_PI/2);
    CGContextDrawImage(context, CGRectMake(0, (imageSize.height - CGImageGetHeight(image)) / 2, CGImageGetWidth(image), CGImageGetHeight(image)), image);
